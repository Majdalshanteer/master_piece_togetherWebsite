            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Workers</h4>
       ...
       @endforeach
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span class="badge badge-light-warning">{{ $worker->id }}</span></td>
                                                <td><a href="javascript:void(0)" class="font-weight-medium link">{{ $worker->name }}</a></td>
                                                <td><a href="javascript:void(0)" class="font-bold link"><img src="/images/{{ $worker->image }}"  width="80px" height="80px"></a></td>
                                                <td>{{ $worker->email }}</td>
                                                <td>{{ $worker->phone }}</td>
                                                <td>{{ $worker->type }}</td>
                                                <td>
                                                    ...
                                                    <form style="display: inline-block" method="POST"
                                                        action="{{ route('workersinfo.destroy',$worker->id) }}"onsubmit="return confirm('Are you sure?');" >
                                                        <a   href="{{ route('workersinfo.edit', $worker->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-pencil-square" viewBox="0 0 16 16">
